...
/***/ function(module, exports, __webpack_require__) {
	...
	_react2['default'].render(_react2['default'].createElement(_componentsCanvas.Canvas, null), document.getElementById('main'));
	...
	var Canvas = (function (_React$Component) {
	  ...
	  _createClass(Canvas, [{
	    ...
	    value: function componentDidMount() {
	      var ctx = _react2['default'].findDOMNode(this).getContext('2d');
